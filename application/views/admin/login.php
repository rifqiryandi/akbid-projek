...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<?=base_url()?>assets/admlte/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<!-- AdminLTE App -->
<script src="<?=base_url()?>assets/admlte/dist/js/adminlte.min.js"></script>
